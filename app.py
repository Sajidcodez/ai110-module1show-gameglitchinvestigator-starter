...
#FIX: Refactored core logic into logic_utils.py and updated imports

st.set_page_config(page_title="Glitchy Guesser", page_icon="🎮")

st.title("🎮 Game Glitch Investigator")
st.caption("An AI-generated guessing game. Something is off (but needed human intervention to help save the day).")
